...
basin_file = os.path.join('../../Geodatabases/gagesII_9322_point_shapefile',
                    'gagesII_9322_sept30_2011.shp')
HUC2 = gpd.read_file(basin_file)
...
data_path = os.path.join('../../Geodatabases', 'X190.141.230.168.319.15.37.26.nc')
